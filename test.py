...
def main():
    ...
    # Initialize tabs
    tabs = st.tabs(["Model & Dataset", "Hyperparameters", "Data Columns", "Advanced Settings"])
    ...
    with tabs[0]:
        ...
        with col1:
            st.markdown("##### Model Name (Hugging Face Model Hub)")
            model_name = st.text_input(
                "Enter the name of the pre-trained model from Hugging Face.",
        ...
        with col3:
            st.markdown("##### Config Name (optional)")
            config_name = st.text_input(
                "If the dataset has multiple configurations, specify one here.",
